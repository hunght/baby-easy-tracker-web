      ...
      <div className="space-y-8">
        <section>
          <p className="text-base">
            Easy Baby Tracker ("we", "our", or "us") operates the Easy Baby Tracker mobile application
        ...
        <section>
          ...
          <p className="mb-4">
            Easy Baby Tracker is designed with your privacy in mind. All data collected by the app
            is stored locally on your device. We do not collect, transmit, or store any personal
            information on external servers.
          </p>
          <h3 className="mb-3 text-xl font-semibold">Data Stored Locally</h3>
          <p className="mb-2">The app stores the following types of data on your device:</p>
          <ul className="ml-6 list-disc space-y-2">
            ...
            <li>Health records (temperature, medications, symptoms, doctor visits)</li>
        ...
        <section>
          <h2 className="mb-4 text-2xl font-semibold">Camera and Photo Library Access</h2>
          <p>
            The app may request access to your device's camera and photo library to allow you to:
          </p>
          <ul className="ml-6 list-disc space-y-2">
          ...
          <p className="mt-4">
            All photos are stored locally on your device and are never uploaded to external servers.
            You can deny these permissions and still use all other features of the app.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            The app may send local notifications to remind you about feeding schedules or other
            baby care activities. These notifications are generated locally on your device and
            do not involve any external services.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            Easy Baby Tracker does not use any third-party analytics, advertising, or tracking services.
        ...
        <section>
          ...
          <p>
            Our Service is designed for tracking baby care information. We do not knowingly collect
            any personal information from children. All data entered into the app is controlled by
            the parent or guardian and stored locally on their device.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            You can delete any data stored by the app at any time through the app's interface.
        ...
        <section>
          ...
          <p>
            ...
            by updating the "Last updated" date at the top of this Privacy Policy. You are advised
